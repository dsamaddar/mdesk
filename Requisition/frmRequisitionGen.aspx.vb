...
Partial Class Requisition_frmRequisitionGen
    ...
    Protected Sub ShowItemImage(ByVal ItemID As String)
        imgItemImage.ImageUrl = ConfigurationManager.AppSettings("item_img_storage") & ItemData.fnGetItemImageNm(ItemID).ToString()
    End Sub
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        ...
        If Check = 1 Then
            ...
            MailProp = ItemRequisitionData.fnGetMailResReqSubmitted(ItemRequisitionInfo)
    ...
    Protected Sub drpItemList_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles drpItemList.SelectedIndexChanged
        ...
        ShowItemImage(drpItemList.SelectedValue)
    End Sub
